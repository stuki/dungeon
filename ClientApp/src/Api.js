...
class Api {
  ...
  createPlayer = player => {
    this.players.post(player).catch(err => console.log(err));
  };
  ...
  createSession = session =>
    this.sessions.post(session).catch(err => console.log(err));
  ...
  createCharacter = character => {
    this.characters.post(character).catch(err => console.log(err));
  };
  ...
  deleteCharacter = character =>
    this.characters(character.id)
      .delete()
      .catch(err => console.log(err));

  createLog = log => {
    this.logs.post(log).catch(err => console.log(err));
  };
