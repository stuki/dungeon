...
class CreateCharacter extends Component {
  ...
  render() {
    ...
    const attributes = [
      {
        name: "Constitution",
        help: "How sturdy you are, determines how many hit points you have"
      },
      {
        name: "Charisma",
        help:
          "Can you charm your way out of any situation, and barter anything?"
      },
      {
        name: "Dexterity",
        help: "Nimble and agile, useful in tight spots and leaps of faith"
      },
      {
        name: "Intelligence",
        help: "How book smart are you, and how is your skill in magic"
      },
      {
        name: "Strength",
        help:
          "Determines how much you can carry, or how much damage you can cause"
      },
      {
        name: "Wisdom",
        help: "As opposed to intelligence, wisdom is more about street smarts"
      }
    ].map(attr => (
      <FieldGroup
      ...
      <div id="character-form">
        ...
        <Form className="characterSheet" onSubmit={this.handleSubmit}>
          ...
          <FieldGroup
            ...
            bsSize="small"
          />
          <Col md={6}>{attributes.slice(0, 3)}</Col>
          <Col md={6}>{attributes.slice(3)}</Col>
